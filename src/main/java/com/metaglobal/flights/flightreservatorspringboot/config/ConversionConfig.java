...
import com.metaglobal.flights.flightreservatorspringboot.converter.ReservationEntityToReservationResponseConverter;
import com.metaglobal.flights.flightreservatorspringboot.converter.ReservationRequestToReservationEntityConverter;
...
public class ConversionConfig {
    private Set<Converter> getConverters() {
        ...
        converters.add(new FlightEntityToReservableFlightResponseConverter());
